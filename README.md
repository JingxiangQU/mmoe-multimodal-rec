...
[![Hugging Face Model_v3](https://img.shields.io/badge/🤗%20Model-jingxiang11111%2FHoME--rec-blue)](https://huggingface.co/jingxiang11111/HoME-rec)
...
* **模型 (MMoE Multimodal Recommender)**: 训练好的 MMoE 模型和 HoME 文件。
    ...
    [前往 Hugging Face 模型HoME](https://huggingface.co/jingxiang11111/HoME-rec)
